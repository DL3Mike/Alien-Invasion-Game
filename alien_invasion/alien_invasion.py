...
class AlienInvasaion:
    ...
    def __init__(self):
        ...
        self.ke = KeyEvents(self)

    def run_game(self):
        """Start the main loop for the game."""
        while True:
            self.ke._check_events()
    ...
    def _check_bullet_alien_collisions(self):
        """ Resepond to bullet-alien collisions. """
    ...
    def _update_aliens(self):
        """ Check if the fleet is at an edge, then Update the postion of all aliens in the fleet. """
    ...
    def _ship_hit(self):
        """ Respond to the being hit by alien. """
    ...
    def _update_screen(self):
        ...
        # Draw the play button to the screen if game is inactive
